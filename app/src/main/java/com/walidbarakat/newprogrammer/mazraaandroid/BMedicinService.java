...
public class BMedicinService  extends IntentService {
    private static final int NOTIFICATION_ID = FollowBabyActivity.BMedicinNotificationId;

    public BMedicinService() {
        super("BMedicinService");
    }
    ...
    protected void onHandleIntent(@Nullable Intent intent) {
        ...
        builder.setContentText("يوجد علاجات مواليد يجب تنفيذها اليوم");

...
public class BTahsynService extends IntentService {
    private static final int NOTIFICATION_ID = FollowBabyActivity.BTahsynNotificationId;

    public BTahsynService() {
        super("BTahsynService");
    }
    ...
    protected void onHandleIntent(@Nullable Intent intent) {
        ...
        builder.setContentText("يوجد تحصينات مواليد يجب تنفيذها اليوم");
